...
namespace APIMoto.Controllers
{
    ...
    public class TypeProductsController : ControllerBase
    {
        ...
        public TypeProductsController(MotoEkipContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<TypeProduct>> PostTypeProduct(TypeProduct typeProduct)
        {
            ...
            return CreatedAtAction("GetTypeProduct", new { id = typeProduct.IdType }, typeProduct);
        }
        ...
        {
            return _context.TypeProducts.Any(e => e.IdType == id);
        }
    }
}
